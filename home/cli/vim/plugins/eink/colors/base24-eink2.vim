...
hi Comment         cterm=none          ctermbg=none    ctermfg=20
hi Conceal         cterm=none          ctermbg=none    ctermfg=12
hi Func            cterm=none          ctermbg=11      ctermfg=8
hi SpecialKey      cterm=none          ctermbg=none    ctermfg=8
hi Folded          cterm=none          ctermbg=18      ctermfg=8
hi FoldColumn      cterm=none          ctermbg=18      ctermfg=8
hi LineNr          cterm=none          ctermbg=18      ctermfg=8
hi StatusLine      cterm=bold          ctermbg=18      ctermfg=8
hi StatusLineNC    cterm=none          ctermbg=18      ctermfg=8
hi VertSplit       cterm=none          ctermbg=18      ctermfg=8
hi ColorColumn     cterm=none          ctermbg=18      ctermfg=1
hi CursorLineNr    cterm=none          ctermbg=18      ctermfg=21
hi SignColumn      cterm=none          ctermbg=18      ctermfg=8

hi AleErrorSign    cterm=none          ctermbg=18      ctermfg=1
hi AleWarningSign  cterm=none          ctermbg=18      ctermfg=3
